...
Нажмите здесь, чтобы открыть личный чат: @botname
  ...
  commands: {
    ...
    airide: {
      usageHint: 'Отправьте /airide с описанием поездки в свободной форме для создания.\nДля обновления: /airide #rideId <что изменить>',
      sessionAlreadyActive: 'У вас уже есть активная сессия AI-поездки. Пожалуйста, подтвердите или отмените ее сначала.',
      sessionExpired: 'Сессия истекла. Пожалуйста, используйте /airide снова.',
      parsing: '🤖 Обрабатываю детали поездки...',
      parseError: '❌ Не удалось распознать детали поездки. Попробуйте снова с более понятным описанием.',
      tooManyRetries: '❌ Не удалось извлечь необходимые данные после нескольких попыток. Попробуйте /airide снова.',
      cancelled: 'Создание поездки отменено.',
      confirmButton: '✅ Подтвердить',
      confirmPrompt: '📋 Пожалуйста, проверьте детали поездки выше и подтвердите.',
      missingField: {
        title: '❓ Как назвать эту поездку?',
        when: '❓ Когда состоится поездка? (например, "завтра в 18:00", "в субботу в 10:00")'
      }
    }
  },
  formatter: {
