...
<h3>🗓 Список запланированных райдов</h3>

<p>Используйте /planned в личном чате, чтобы посмотреть райды начиная с сегодняшнего дня, в которых вы участвуете или думаете об участии:</p>

<ul><li>Райды сортируются по дате (ближайшие сначала)</li><li>Сегодняшние райды остаются в списке после времени старта</li><li>Для каждого райда показывается ваш текущий статус участия</li></ul>
    `.trim(),
...
Нажмите здесь, чтобы открыть личный чат: @botname
  ...
  buttons: {
    ...
    mainMenuPlannedRides: '🗓 Запланированные райды',
  ...
  formatter: {
    ...
    noPlannedRides: 'У вас нет запланированных райдов.',
    plannedRidesTitle: 'Ваши запланированные райды',
    participationStatus: {
      joined: '🙋 Участвую',
      thinking: '🤔 Думаю'
    },
  ...
  bot: {
    commandDescriptions: {
      ...
      planned: 'Показать запланированные райды',
