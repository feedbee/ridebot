...
- **Participation**: User participation states (joined, thinking, skipped) for each ride
...
- **ListParticipantsCommandHandler**: List all participants for a specific ride (shows all without truncation)
